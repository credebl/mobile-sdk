...
import { type FormattedSubmissionEntry, type FormattedSubmissionEntrySatisfiedCredential, getAttributesAndMetadataForMdocPayload, getCredentialForDisplay, type FormattedSubmission } from './display'
import {
...
export class OpenID4VCSDK implements MobileSDKModule {
  ...
  public async getSubmissionForMdocDocumentRequest(
