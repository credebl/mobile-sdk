...
type FormatReturn = Awaited<ReturnType<DidCommAgent['didcomm']['proofs']['getFormatData']>>
...
export const ProofFormatDataProvider: React.FC<PropsWithChildren<Props>> = ({ agent, children }) => {
